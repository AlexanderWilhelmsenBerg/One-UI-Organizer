...
class GeneralKnownAppRulesTest {
    ...
    private fun expectedRules(): Map<String, AppCategory> = buildMap {
        putPackages(
    ...
    private fun MutableMap<String, AppCategory>.putPackages(category: AppCategory, vararg packageNames: String) {
